...
import com.example.yashi.e_attendanceregister.database.*;
import com.example.yashi.e_attendanceregister.adapter.*;
...
public class StudentProfileActivity extends AppCompatActivity {
    ...
    DatabaseHandler handler = MainActivity.handler;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent launchIntent = new Intent(profileActivity, StudentRegisterActivity.class);
    ...
    public void find(View view) {
        ...
        if (cursor == null || cursor.getCount() == 0) {
            ...
            buffer += " " + "Mobile No: " + cursor.getString(3) + "\n";
