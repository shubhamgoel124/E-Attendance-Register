...
public class SchedularActivity extends AppCompatActivity implements AdapterView.OnItemLongClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent launchIntent = new Intent(getBaseContext(), CreateSchedularActivity.class);
